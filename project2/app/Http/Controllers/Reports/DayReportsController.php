...
class DayReportsController extends Controller
{
    ...
    public function index(  Request $request  )
    {
        ...
        $this->data['receipts'] = Receipts::select('users.name', 'users.phone', DB::raw('SUM(receipts.amount) as amount') )
        ...
        $this->data['payments'] = Payments::select('users.name', 'users.phone', DB::raw('SUM(payments.amount) as amount') )
