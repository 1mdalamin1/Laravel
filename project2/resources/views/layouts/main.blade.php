...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ asset('backend') }}/starter.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Starter Page</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{ asset('backend') }}/iframe.html" class="nav-link">
              <i class="nav-icon fas fa-ellipsis-h"></i>
              <p>Tabbed IFrame Plugin</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ asset('backend') }}/https://adminlte.io/docs/3.1/" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="{{ asset('backend') }}/https://adminlte.io">AdminLTE.io</a>.</strong>
    All rights reserved.
