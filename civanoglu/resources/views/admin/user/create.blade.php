    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="" data-feather="user-plus"></i> Add New User
            </h2>

            <div class="min-w-max">
                <a href="{{route('dashboard-user.index')}}" class="fullwidth-btn"><i class="" data-feather="arrow-left"></i> Back</a>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{route('dashboard-user.store')}}" method="post" class="p-6 bg-white border-b border-gray-200" enctype="multipart/form-data"> @csrf
                    ...
                    <div class="mb-6">
                        <label class="civanoglu-label" for="email">Email <i class="" data-feather="mail"></i><span class="required-text">*</span></label>
                    ...
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                            <label class="civanoglu-label" for="password_confirmation">Password confirm <span class="required-text">*</span></label>
                    ...
                    <button class="btn" type="submit"><i class="" data-feather="user-plus"></i> Save</button>
                </form>
            </div>
        </div>
    </div>
