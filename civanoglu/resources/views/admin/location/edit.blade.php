    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="" data-feather="navigation-2"></i> Edit | Update Location
            </h2>

            <div class="min-w-max">
                <a href="{{route('dashboard-location.index')}}" class="fullwidth-btn"><i class="" data-feather="arrow-left"></i> Back</a>
            </div>
        </div>
    </x-slot>
