    ...
    <div class="text-center">
        ...
        <div class="container py-14">
            ...
            <div class="flex flex-wrap -mx-3 justify-between mt-10">
                ...
                <?php $__currentLoopData = $latest_properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('components.single-property-card', ['property'=> $property, 'width' => 'md:w-1/4 w-full'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<?php /**PATH E:\0namica\htdocs\Laravel\civanoglu\resources\views/welcome.blade.php ENDPATH**/ ?>