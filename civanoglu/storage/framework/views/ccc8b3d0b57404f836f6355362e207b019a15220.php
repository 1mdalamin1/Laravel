...
<div class="flex-1 mx-2 shadow-lg relative rounded-md mb-6">
    ...
    <div class="p-3">
        <h2 class="leading-0 text-base"><?php echo e($property->name); ?></h2>
        <h3 class="text-2xl py-3"><?php echo e($property->price); ?> TL</h3>
        <div class="border-t-2">
            ...
            <a href="<?php echo e(route('single-property', $property->id)); ?>" class="btn w-full text-center">More details</a>

        </div>
    </div>
</div>
<?php /**PATH E:\0namica\htdocs\Laravel\civanoglu\resources\views/components/single-property-card.blade.php ENDPATH**/ ?>